...
export default function DateLoc(){
    return <section className="w-full h-screen flex flex-col gap-16 p-6 lg:justify-between lg:flex-row lg:items-center" id="date-time">
        ...
        <div className="h-full location-section flex flex-col items-center">
            ...
            <p className="text-center mb-6">Daan Mogot Rd No.50 B, Wijaya Kusuma, Grogol Petamburan, Jakarta, 11460</p>
