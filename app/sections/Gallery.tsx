...
export default function Gallery() {
  return (
    <div className="relative w-full aspect-4/5 bg-[url(/photoshoot/cover.jpg)] bg-cover bg-center" id="gallery">
      ...
      <div className="absolute top-0 w-full h-full px-20">
        ...
        <ViewPhotoBtn position="top-[calc(75%-0.5rem)] right-1/5 md:top-3/4 md:right-[calc(20%+2.5rem)]"/>
      </div>
    </div>
  );
}
